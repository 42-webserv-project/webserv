...
8. If you allocate memory (use smart pointers) or open fd or use another resource that should be cleaned later on - leave comment like 'need to check proper cleaning'
